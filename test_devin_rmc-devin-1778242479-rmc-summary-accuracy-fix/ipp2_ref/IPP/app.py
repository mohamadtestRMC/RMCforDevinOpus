"""
IPP Jobtrack MRR Auto-Fill Platform
Director-Level Dashboard & Engine
"""
...
st.set_page_config(
    page_title="IPP Jobtrack MRR Platform",
...
def main():
    ...
    with st.sidebar:
        ...
        <div style="text-align:center; margin-bottom:20px; margin-top: 10px;">
            ...
            <div style="font-size:11px; color:#64748B;">Jobtrack MRR Auto-Fill</div>
        </div>
        """, unsafe_allow_html=True)

        st.markdown("---")
        st.markdown("### Upload Files")
        st.caption("Upload your 3 monthly files to auto-fill MRR data.")
    ...
    # ── Main Content ──
    try:
        with open("assets/ipp-logo.png", "rb") as f:
            logo_b64 = base64.b64encode(f.read()).decode()
        logo_html = f'<div style="text-align: center; margin-bottom: 16px;"><img src="data:image/png;base64,{logo_b64}" style="max-height: 120px;"></div>'
    except Exception:
        logo_html = ''

    st.markdown(f"""
    {logo_html}
    <div class="hero-title">Jobtrack MRR Auto-Fill Platform</div>
    <div class="hero-sub">Upload your monthly files to auto-fill MR#, Rate, and Value. All rules are dynamic and adapted for any month.</div>
    """, unsafe_allow_html=True)
